...
var Anki = {
  hasPointsForTrick: function hasPointsForTrick(requiredPoints) {
    console.log("required points: " + requiredPoints);
    return true;
  },
  noPointsForTrick: function noPointsForTrick(trickName) {
    console.log("no points for trick: " + trickName);
  },
  hasCoinsForTrick: function hasCoinsForTrick(requiredCoins) {
    console.log("required coins: " + requiredCoins);
    return true;
  },
  noCoinsForTrick: function noCoinsForTrick(trickName) {
    console.log("no money for trick: " + trickName);
  },
  unableTrick: function unableTrick(trickName) {
    console.log("unable to do " + trickName);
  },
  doTrick: function doTrick(trickName) {
    console.log("do trick " + trickName);
  },
  updateBestScore: function updateBestScore(score) {
    console.log("best score " + score);
  },
  getAnkiPoints: function getAnkiPoints() {
    return 50000;
  },
  getAnkiCoins: function getAnkiCoins() {
    return 20;
  },
